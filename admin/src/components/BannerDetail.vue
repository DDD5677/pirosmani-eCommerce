		...
		<form  v-if="!bannerLoading" enctype="multipart/form-data">
			<div class="category-info">
				<div class="name">
					...
					<textarea placeholder="Title of banner" cols="30" rows="2"  @change="assignData($event,'title')">{{ banner.title }}</textarea>
				</div>
				<div class="name">
					<span class="title">Banner subtitle</span>
					<textarea placeholder="Subtitle of banner" cols="30" rows="2"  @change="assignData($event,'subtitle')">{{ banner.subtitle }}</textarea>
				</div>
				<div class="name">
				...
				<div class="name">
					...
					<input placeholder="Button text of banner" type="text" :value="banner.button"  @change="assignData($event,'button')">
				</div>
			</div>
			<div class="img-box">
			...
			<div class="review-btns">
				...
				<button @click.prevent="deleteBanner" class="review-delete"><i class="fa fa-trash" aria-hidden="true"></i> Delete</button>
			</div>
		</form>
	</div>
</template>
