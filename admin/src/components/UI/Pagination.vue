<template>
	<div class="pagination__wrapper">
		...
		<ul class="pagination">
			<li v-for="pageNum in links" class="page-item" @click.prevent.stop="changePageData(pageNum)">
			...
			<li class="page-item" @click.prevent.stop="changePageData(increamentPage())">
				<a class="page-link" href="#"><img src="@/assets/images/pagination-arrow.svg" alt="" /></a>
			</li>
		</ul>
	</div>
</template>
