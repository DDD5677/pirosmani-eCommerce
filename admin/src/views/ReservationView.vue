					...
					<div class="filters">
						<div class="search">
							<input type="text" placeholder="Search" v-model="search" class="search__input"
								@change="getReservations(1, this.$route.query.limit)">
					...
					<table>
						<thead>
							<tr>
								...
								<th v-if="options[2].show">
									<span @click="sortHandler('numOfPeople')" class="sort_btn">
										{{ options[2].title }}
										<i v-if="sort === 'numOfPeople' || sort === '-numOfPeople'" class="fa fa-arrow-up"
											:class="sort[0] === '-' ? 'rotate' : ''" aria-hidden="true"></i>
									</span>
								</th>
								<th v-if="options[3].show">
									<span @click="sortHandler('time')" class="sort_btn">
										{{ options[3].title }}
										<i v-if="sort === 'time' || sort === '-time'" class="fa fa-arrow-up"
											:class="sort[0] === '-' ? 'rotate' : ''" aria-hidden="true"></i>
									</span>
								</th>
								<th v-if="options[4].show">
									<span class="sort_btn" @click="sortHandler('date')">
										{{ options[4].title }}
										<i v-if="sort === 'date' || sort === '-date'" class="fa fa-arrow-up"
											:class="sort[0] === '-' ? 'rotate' : ''" aria-hidden="true"></i>
									</span>
								</th>
							...
							<div v-if="checked > 0" class="checked__block">
								...
								<a @click.prevent="deleteReservations" class="delete__btn"><i class="fa fa-trash"
						...
						<tbody v-if="!reservationLoading && !reservationError">
							...
							<tr v-for="reserv in reservations" :id="reserv.id">
								...
								<td v-if="options[5].show" @click="reservationDetail(reserv.id)">{{ formatDate(reserv.createdAt) }}
								</td>
