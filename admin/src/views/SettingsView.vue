			...
			<div v-if="!isLoading" class="settings-inner">
					...
					<form  @submit.prevent="submitHandler" enctype="multipart/form-data">
						<div class="labels">
							...
							<label class="custom-file-upload">
								<div>
									<span class="upload__title">Change Avatar<i class="fa fa-cloud-upload" aria-hidden="true"></i></span>
						...
						<div class="body">
							...
							:errors="errors" 
							:error="errors?errors.extraPhone:''" 
							v-model="extraPhone"/>
						</div>
						<div class="btns">
				...
				<div class="site-info">
					...
					<div class="body">
						...
						:errors="infoErrors" 
						:error="infoErrors?infoErrors.mainPhone:''" 
						v-model="mainPhone"/>
						<form-input
						class="inputs" 
						:label="'Order phone'" 
						...
						:errors="infoErrors" 
						:error="infoErrors?infoErrors.orderPhone:''" 
						v-model="orderPhone"/>
						<form-input
						class="inputs" 
						:label="'Email for site'" 
						:type="'email'" 
						:placeholder="'Email for site'" 
						:errors="infoErrors" 
						:error="infoErrors?infoErrors.email:''" 
						v-model="mainEmail"/>
						<form-input
						class="inputs" 
						:label="'Telegram'" 
						...
						:errors="infoErrors" 
						:error="infoErrors?infoErrors.telegram:''" 
						v-model="telegram"/>
						<form-input
						class="inputs" 
						:label="'Instagram'" 
						...
						:errors="infoErrors" 
						:error="infoErrors?infoErrors.instagram:''" 
						v-model="instagram"/>
						<form-input
						class="inputs" 
						:label="'Youtube video'" 
						...
						:errors="infoErrors" 
						:error="infoErrors?infoErrors.video:''" 
						v-model="video"/>
						<form-input
						class="inputs" 
