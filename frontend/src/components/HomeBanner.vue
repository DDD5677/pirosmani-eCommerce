<template>
	<section class="home__banner">
		<div class="container">
			<button class="tableReservation__btn" @click.prevent="toggleBookTableHandler">
				Забронировать стол
				<img src="@/assets/images/tableReservation__btn-arrow.svg" alt="" />
			</button>
			<swiper v-if="!isLoading" :modules="modules" :spaceBetween='10' :pagination="{ clickable: true }" :autoplay="{
				delay: 2500,
