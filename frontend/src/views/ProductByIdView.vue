					...
					<div class="product__info">
						...
						<div class="product__info-right">
							...
							<div class="product__amount">
								<span>Доступен сейчас</span><span class="num">{{ product.countInStock }} порц.</span>
							</div>
						...
						<div class="product__btns">
							<green-btn @click.prevent.stop="addProductHandler(product, quantity)"
								class="product__buy">Купить</green-btn>
							<router-link :to="{ name: 'basket' }" class="product__basket"><img
									src="@/assets/images/shopping-cart-white.svg" alt="" /></router-link>
						</div>
					</div>
				</div>
